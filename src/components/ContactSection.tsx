  ...
  const contactInfo = [
    {
      ...
      action: () => window.open('tel:+966555555555')
    },
    {
      icon: Mail,
      title: 'البريد الإلكتروني',
      value: 'info@naturalcare.com',
      action: () => window.open('mailto:info@naturalcare.com')
    },
    {
      icon: MapPin,
      title: 'الموقع',
            ...
            <Card className="card-gradient shadow-card border-0 hover-lift transition-smooth">
              <CardContent className="p-8">
                ...
                <Button
                  ...
                  className="hover-for-button w-full bg-success hover:bg-success/90 text-white "
                >
