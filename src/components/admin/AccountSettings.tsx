...
export const AccountSettings: React.FC = () => {
  ...
  const handleSaveSettings = () => {
    ...
    console.log('User entered current password:', currentPassword);
    console.log('Stored password:', currentSettings.password);
    ...
    if (newPassword) {
      ...
      if (currentPassword.trim() !== (currentSettings.password || '').trim()) {
        toast({
