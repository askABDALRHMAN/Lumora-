...
export const CommentsManagement: React.FC = () => {
  ...
  const text = {
    ar: {
      ...
      worning:"تحذير هام جدًا: يجب عليك ترك تعليق واحد على الأقل في التعليقات."
    },
    en: {
      ...
      worning:"Very important warning: You must leave at least one comment in the comments.",
